...
(function( window, angular, undefined ) {
    ...
    (function() {
        ...
        function generateThemes($injector) {
            ...
            if (themeCss.length === 0) 
                return; // no rules, so no point in running this expensive task
            ...
            function menuDefaultOptions($$rAF, $window, $mdUtil, $mdTheming, $timeout, $mdConstant, $document) {
                ...
                function onShow(scope, element, opts) {
                    ...
                    function activateInteraction() {
                        ...
                        if (!focusTarget) 
                            focusTarget = opts.menuContentEl[0].firstElementChild.firstElementChild;
                        focusTarget.focus();
                    }
                }
            ...
            function compile(element, attr) {
                ...
                return function postLink(scope, element, attr, ctrls) {
                    ...
                    mdSelectCtrl.setLabelText = function(text) {
                        if (customLabel) 
                            return; // Assume that user is handling it on their own
                    ...
                    attr.$observe('ngMultiple', function(val) {
                        ...
                        deregisterWatcher = scope.$watch(function() {
                            ...
                            if (multiple === undefined && prevVal === undefined) 
                                return; // assume compiler did a good job
                            if (multiple) {
    ...
    (function() {
        ...
        function MdToastProvider($$interimElementProvider) {
            ...
            .addPreset('simple', {
                ...
                options: /* @ngInject */
                ["$mdToast", "$mdTheming", function($mdToast, $mdTheming) {
                    var opts = {
                        template: [
                        ...
                        controller: /* @ngInject */
                        ["$scope", function mdToastCtrl($scope) {
                            var self = this;
                            $scope.$watch(function() {
    ...
    (function() {
        ...
        $animate, $rootElement, $attrs) {
            ...
            function positionDropdown () {
                if (!elements) 
                    return $timeout(positionDropdown, 0, false);
            ...
            function moveDropdown () {
                ...
                if ($animate.pin) 
                    $animate.pin(elements.$.ul, $rootElement);
            }
            ...
            function handleSearchText (searchText, previousSearchText) {
                ...
                if (searchText !== getDisplayValue($scope.selectedItem)) 
            ...
            function fetchResults (searchText) {
                ...
                function handleResults (matches) {
                    ...
                    if (searchText !== $scope.searchText) 
                        return; //-- just cache the results if old request
                    ctrl.loading = false;
                    promise = null;
        ...
        function MdChip($mdTheming) {
            ...
            function compile(element, attr) {
                ...
                return function postLink(scope, element, attr, ctrl) {
                    ...
                    if (ctrl) 
                        angular.element(element[0].querySelector('.md-chip-content'))
                        .on('blur', function () {
                            ctrl.selectedChip = - 1;
                        });
                };
    ...
    (function() {
        ...
        MdChipsCtrl.prototype.inputKeydown = function(event) {
            ...
            case this.$mdConstant.KEY_CODE.ENTER:
                if (this.$scope.requireMatch || !chipBuffer) 
                    break;
                event.preventDefault();
        ...
        MdChipsCtrl.prototype.appendChip = function(newChip) {
            if (this.items.indexOf(newChip) + 1) 
                return;
            if (this.useMdOnAppend && this.mdOnAppend) {
                newChip = this.mdOnAppend({
                    '$chip': newChip
                });
            }
        ...
        MdChipsCtrl.prototype.configureUserInput = function(inputElement) {
            ...
            .on('keydown', function(event) {
                scope.$apply( angular.bind(ctrl, function() {
    ...
    (function() {
        ...
        $mdUtil, $animate, $attrs, $compile, $mdTheming) {
            ...
            function configureWatchers () {
                $mdUtil.initOptionalProperties($scope, $attrs);
                $attrs.$observe('mdNoBar', function (value) {
                    $scope.noInkBar = angular.isDefined(value);
                });
                $scope.$watch('selectedIndex', handleSelectedIndexChange);
                $scope.$watch('dynamicHeight', function (value) {
                    if (value) 
                        $element.addClass('md-dynamic-height');
                    else 
                        $element.removeClass('md-dynamic-height');
                });
                $scope.$on('$destroy', cleanup);
            }
            ...
            function insertTab (tabData, index) {
                var proto = {
                    ...
                    isActive: function () {
                        return this.getIndex() === $scope.selectedIndex;
                    },
                    isLeft: function () {
                        return this.getIndex() < $scope.selectedIndex;
                    },
                    ...
                    shouldRender: function () {
                        return !$scope.noDisconnect || this.isActive();
                    },
                    hasFocus: function () {
            ...
            function updateInkBarStyles () {
                if (!elements.tabs[$scope.selectedIndex]) 
                    return;
                if (!ctrl.tabs.length) 
